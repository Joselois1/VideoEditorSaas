              ...
              <button
                ...
                className={`
                  ...
                  ${Math.abs(speed - s) < 0.01
                    ...
                    : "bg-white/[0.03] text-zinc-400 border border-white/5 hover:bg-white/[0.06] hover:text-white"
                  }
                `}
              >
                {s}x
        ...
        <div className="flex items-center gap-1.5">
          ...
          <div className="ml-auto flex gap-1">
            <button
              ...
              className={`text-xs px-2 py-1.5 rounded-md font-medium transition-colors border ${fx.flipH ? "bg-violet-500/15 text-violet-300 border-violet-500/30" : "bg-white/[0.03] text-zinc-400 border-white/5 hover:bg-white/[0.06]"}`}
            >⇔</button>
            <button
              onClick={() => onUpdate({ flipV: !fx.flipV })}
              title="Flip vertical"
              className={`text-xs px-2 py-1.5 rounded-md font-medium transition-colors border ${fx.flipV ? "bg-violet-500/15 text-violet-300 border-violet-500/30" : "bg-white/[0.03] text-zinc-400 border-white/5 hover:bg-white/[0.06]"}`}
            >⇕</button>
          </div>
        </div>
      </Row>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="flex-1 bg-zinc-950 border border-white/10 rounded-md px-2 py-1 text-xs text-white focus:border-violet-500 outline-none"
            />
          </div>
          <div className="flex items-center gap-2">
